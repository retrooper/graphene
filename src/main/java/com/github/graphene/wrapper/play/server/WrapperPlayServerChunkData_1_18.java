...
public class WrapperPlayServerChunkData_1_18 extends PacketWrapper<WrapperPlayServerChunkData_1_18> {
    ...
    public WrapperPlayServerChunkData_1_18(PacketSendEvent event) {
        super(event);
    }

    public WrapperPlayServerChunkData_1_18(Column column) {
    ...
    @Override
    public void readData(WrapperPlayServerChunkData_1_18 wrapper) {
